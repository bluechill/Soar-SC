...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/local_GLEW
  TARGETDIR  = ../../lib/univ_d
  TARGET     = $(TARGETDIR)/liblocal_GLEW_d.dylib
  ...
  INCLUDES  += -I../../jni/external/glew/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -g -fPIC -Qunused-arguments -stdlib=libc++ -w
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -L../../lib/univ_d -dynamiclib -flat_namespace -stdlib=libc++ -install_name @loader_path/liblocal_GLEW_d.dylib
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/local_GLEW
  TARGETDIR  = ../../lib/univ
  TARGET     = $(TARGETDIR)/liblocal_GLEW.dylib
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -L../../lib/univ -Wl,-x -dynamiclib -flat_namespace -stdlib=libc++ -install_name @loader_path/liblocal_GLEW.dylib
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -framework OpenGL
  LDDEPS    += 
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
...
ifeq ($(config),debuguniv)
  OBJDIR     = obj/Universal/Debug/local_GLEW
  TARGETDIR  = ../../lib/univ_d
  TARGET     = $(TARGETDIR)/liblocal_GLEW_d.dylib
  DEFINES   += -D_MACOSX -D_DEBUG -DDEBUG -DTEST_NASTY_CONDITIONS -DDISABLE_CPP11 -DGLEW_NO_GLU -DDISABLE_CG -DOGG_DLL= -DVORBIS_DLL= -DVORBISFILE_DLL= -DDISABLE_DX9 -DDISABLE_WGL -DTINYXML_DLL= -DTINYXML_EXT= -DZENI_DLL= -DZENI_EXT= -DZENI_AUDIO_DLL= -DZENI_AUDIO_EXT= -DZENI_CORE_DLL= -DZENI_CORE_EXT= -DZENI_GRAPHICS_DLL= -DZENI_GRAPHICS_EXT= -DZENI_NET_DLL= -DZENI_NET_EXT= -DZENI_REST_DLL= -DZENI_REST_EXT=
  INCLUDES  += -I../../jni/external/glew/include
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -L../../lib/univ_d -dynamiclib -flat_namespace -arch i386 -arch x86_64 -stdlib=libc++ -install_name @loader_path/liblocal_GLEW_d.dylib
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -framework OpenGL
  LDDEPS    += 
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
...
ifeq ($(config),releaseuniv)
  OBJDIR     = obj/Universal/Release/local_GLEW
  TARGETDIR  = ../../lib/univ
  TARGET     = $(TARGETDIR)/liblocal_GLEW.dylib
  DEFINES   += -D_MACOSX -DNDEBUG -DDISABLE_CPP11 -DGLEW_NO_GLU -DDISABLE_CG -DOGG_DLL= -DVORBIS_DLL= -DVORBISFILE_DLL= -DDISABLE_DX9 -DDISABLE_WGL -DTINYXML_DLL= -DTINYXML_EXT= -DZENI_DLL= -DZENI_EXT= -DZENI_AUDIO_DLL= -DZENI_AUDIO_EXT= -DZENI_CORE_DLL= -DZENI_CORE_EXT= -DZENI_GRAPHICS_DLL= -DZENI_GRAPHICS_EXT= -DZENI_NET_DLL= -DZENI_NET_EXT= -DZENI_REST_DLL= -DZENI_REST_EXT=
  INCLUDES  += -I../../jni/external/glew/include
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -L../../lib/univ -Wl,-x -dynamiclib -flat_namespace -arch i386 -arch x86_64 -stdlib=libc++ -install_name @loader_path/liblocal_GLEW.dylib
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -framework OpenGL
  LDDEPS    += 
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
...
$(OBJDIR)/glew.o: ../../jni/external/glew/src/glew.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
